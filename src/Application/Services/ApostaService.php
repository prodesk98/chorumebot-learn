...
class ApostaService {
    ...
    public function __construct(Discord $discord, $config, User $userRepository, Event $eventRepository, EventBet $eventBetsRepository)
    {
    ...
    public function apostaEntrar(Interaction $interaction){

...
class GenericCommandService {
    ...
    public function __construct(Discord $discord, $config, User $userRepository, UserCoinHistory $userCoinHistoryRepository) {
    ...
    public function topApostadores(Interaction $interaction){
    ...
    public function transferir(Interaction $interaction){

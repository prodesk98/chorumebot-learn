...
use Chorume\Application\Commands\LittleAirplanesCommand;
...
$littleAirplanesCommand = new LittleAirplanesCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository);
...
$discord->listenCommand('avioeszinhos', [$littleAirplanesCommand, 'fly']);

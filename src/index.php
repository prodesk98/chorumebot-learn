...
use Chorume\Application\Commands\Generic\TopBettersCommand;
...
$topBettersCommand = new TopBettersCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository);
...
$discord->listenCommand(['top', 'apostadores']  , $topBettersCommand);
